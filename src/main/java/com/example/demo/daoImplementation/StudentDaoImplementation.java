...
public class StudentDaoImplementation implements StudentDao 
{
	...
	public Student saveStudent(Student s)
	{
		...
		if (repository.existsByPhoneNo(s.getPhoneNo()))
			throw new EntityAlreadyExist("Student is already present with the number " + s.getPhoneNo());
	...
	public Student fetchStudentByID(int id) {
		...
		return optional.orElseThrow(() -> new EntityNotPresentException("Student with the Id " + id + " is not available to Update"));
	}
	...
	public Student fetchStudentByNumber(String number) 
	{
		...
		return optional.orElseThrow(() -> new EntityNotPresentException("Student with the number " + number + " is not available to Update"));
	}
